...
public class ArrayList<T> implements ListADT<T>, Iterable<T> {
	 ...
	 *
	 * @param target
	 *            the element that the list is searched for
	 ...
	 *
	 * @param target
	 *            the element that the list will be searched for
	 * @return the integer index into the array containing the target element, or
