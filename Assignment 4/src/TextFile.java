...
public class TextFile {
	...
	/**
	 * Checks that the specified name corresponds to an existing file and if so it
	 * opens the file
	 * 
	 * @param name
	...
	/**
	 * Writes a character to the output file, except the character used to mark end
	 * of file
	 * 
	 * @param c
	...
	/**
	 * Writes a character to the output file, even the character used to mark end of
	 * file
	 * 
	 * @param c
	 *            Character to write to the output file
	...
	/**
	 * Reads the next character from the input file. If all the characters have been
	 * read this method returns EOF
	 * 
	 * @return Next character from the input file or EOF if the whole file has
	 *         already been read.
	 */
	...
	/**
	 * Reads characters from the current position of the input file until the end of
	 * line is reached. The String read is returned.
	 * 
	 * @return String of characters from current position in input file until the
	 *         end of line. returns null if there are no more characters to read
	 *         from the file.
	 */
