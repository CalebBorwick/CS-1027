public class Huffman {
	...
	// Method to compress a text file with the help of its corresponding frequency
	// file
	...
	// This helper method reads the symbol frequency file and returns an ordered
	// list
	// of Huffman pairs
	...
	/**
	 * Computes the padding bits used to complete the last byte to be written to the
	 * compressed file. These bits need not be a prefix of any of the Huffman codes.
	 * 
