...
public class CompressedFile {
	...
	/**
	 * Checks that the specifed name corresponds to an existing file and if so it
	 * opens the file
	 * 
	 * @param name
	...
	/**
	 * Reads the next bit from the input file. If all the bits have been read this
	 * method returns EOF. Bit returned is first converted to a char, so this method
	 * returns a bit as either '0' or '1'.
	 * 
	 * @return Next bit from the input file or EOF if there are no more bits in it.
	 */
	public char readBit() {
		char c = 0;
